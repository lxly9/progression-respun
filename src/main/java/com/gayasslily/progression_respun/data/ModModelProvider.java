...
import static com.gayasslily.progression_respun.item.ModItems.*;
import static com.gayasslily.progression_respun.compat.VanillaItems.*;
import static com.gayasslily.progression_respun.compat.GalosphereItems.*;
import static com.gayasslily.progression_respun.compat.EnderscapeItems.*;

public class ModModelProvider extends FabricModelProvider {
    public static final Map<Model, List<Item>> ITEM_MODEL_LISTS = Map.ofEntries(
            Map.entry(Models.GENERATED, List.of(
                    FLINT_BAR, POLISHED_DIAMOND, RAW_COPPER_BAR, RAW_IRON_BAR, RAW_GOLD_BAR, FIRESTARTER, DIAMOND_SHARD, NETHERITE_HORSE_ARMOR, CHAINMAIL_HORSE_ARMOR, WORM
            )),
